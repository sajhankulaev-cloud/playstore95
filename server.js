...
app.get("/api/games", (req, res) => {
  try {
    ...
    let computed = all.map(g => {
      ...
      const base = { id:g.id, name:g.name, cover:g.cover, platform:g.platform, discPerc: reg?reg.discPerc:0, discountedUntil: reg?(reg.discountedUntil||null):null, finalPriceRub: rub, popRank:g.popRank||999999 };
